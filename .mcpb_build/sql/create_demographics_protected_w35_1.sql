-- Create protected demographics view for Wave 35.1
-- Privacy protections:
...
CREATE OR REPLACE VIEW `chip50.public.demographics_protected_w35_1` AS
SELECT
...
ALTER VIEW `chip50.public.demographics_protected_w35_1`
SET OPTIONS (
  description = 'Privacy-protected demographic data for Wave 35.1. User IDs removed, geography aggregated to regions.',
